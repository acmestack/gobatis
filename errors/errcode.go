...
var PARSE_TABLEINFO_NOT_STRUCT *ErrCode = New("11102", "Parse interface's info but not a struct")
var PARSE_TABLEINFO_NOT_SLICE *ErrCode = New("11103", "Parse interface's info but not a slice")
var PARSE_TABLEINFO_NOT_MAP *ErrCode = New("11104", "Parse interface's info but not a map")
var PARSE_TABLEINFO_NOT_SIMPLETYPE *ErrCode = New("11105", "Parse interface's info but not a simple type")
